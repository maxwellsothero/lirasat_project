                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                ...
                                <div class="d-inline">
                                    <h5>Painel de Desempenho de Motorista</h5>
                                    <span>Desempenho analisado por Motorista</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class=" breadcrumb breadcrumb-title breadcrumb-padding">
                                    ...
                                    <li class="breadcrumb-item"><a href="#!">Imprimir</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#!">Painel de Desempenho de Motorista</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="dt-responsive table-responsive">
                                    ...
                                    function ranking(){
                                      ...
                                      curl_setopt_array($curl, [
                                        ...
                                        CURLOPT_POSTFIELDS => "{\n  \"StartDate\": \"2023-11-10T12:46:56.316Z\",\n  \"EndDate\": \"2023-11-18T12:46:56.316Z\"\n  \n}",
                                        CURLOPT_HTTPHEADER => [
                                      ...
                                      if ($err) {
                                        ...
                                        if ($data) {
                                          $chavesDesejadas = ['Driver', 'AverageSpeed', 'IdleMotorTime','Duration', 'DailyAverageGrade','Displacement'];
                                  
                                          echo '<table id="footer-search" class="table table-striped table-bordered nowrap">
                                                  <thead>
                                                    <tr>
                                                     
                                                      <th><strong>Motorista</strong></th>
                                                      <th><strong>Vel. Média</strong></th>
                                                      <th><strong>Tempo M. Ociosoo</strong></th>
                                                      <th><strong>Duração</strong></th>
                                                      <th><strong>Nota Média Diária</strong></th>
                                                      <th><strong>KM Rodados</strong></th>
                                          ...
                                          foreach ($data as $item) {
                                            echo '<tr>';
                                            foreach ($chavesDesejadas as $chave) {
                                              echo '<td>'.$item[$chave].'</td>';
                                            }
                                            echo '</tr>';
                                          }
                                          ...
                                          echo '<p class="text-danger">Erro ao processar os dados JSON.</p>';
                                        }
                                      }
                                    }

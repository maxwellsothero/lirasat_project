                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Analise de BDV.</h5>
                                            <span>Analise de desempenho da Frota.</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="card" style=" height: 100%;">
                                                    <div class="card-header">
                                                        <h5>KPI Produtividade</h5>
                                                        <span></span>
                                                    </div>
                                                    <div class="card-block">
                                                        
                                                            <div>
                                                                 <h5 class="align-center">Km/l</h5>
                                                                 <div data-label="10" class="radial-bar radial-bar-10 radial-bar-lg radial-bar-default"></div> 
                                                            </div>                                                                                        
                                                                                                      
                                                            <div>
                                                                <h5>KM</h5>
                                                                <div data-label="7500" class="radial-bar radial-bar-20 radial-bar-lg "></div>
                                                            </div>  
                                                            
                                                            <div>
                                                                <h5>Litros</h5>
                                                                <div data-label="3253" class="radial-bar radial-bar-30 radial-bar-lg "></div>
                                                            </div>

                                                            <div>
                                                                <h5>Economia Diesel</h5>
                                                                <div data-label="430" class="radial-bar radial-bar-80 radial-bar-lg "></div>
                                                            </div>        
                                            ...
                                            <div class="col-lg-2" >
                                                <div class="card" style=" height: 100%;">
                                                    <div class="card-header" >
                                                        <h5>KPI Telemetria</h5>
                                                        <span></span>
                                                    </div>
                                                    <div class="card-block">
                                                        
                                                            <div>
                                                                 <h5 class="align-center">Nota Eco</h5>
                                                                 <div data-label="95.7" class="radial-bar radial-bar-95 radial-bar-lg radial-bar-default"></div> 
                                                            </div>                                                                                        
                                                                                                      
                                                            <div>
                                                                <h5>RPM Eco</h5>
                                                                <div data-label="80%" class="radial-bar radial-bar-85 radial-bar-lg "></div>
                                                            </div>  
                                                            
                                                            <div>
                                                                <h5>M.L</h5>
                                                                <div data-label="10,14%" class="radial-bar radial-bar-10 radial-bar-lg "></div>
                                                            </div>

                                                            <div>
                                                                <h5>KMLV</h5>
                                                                <div data-label="75" class="radial-bar radial-bar-75 radial-bar-lg "></div>
                                                            </div>        
                                            ...
                                            <!-- CATEGORIES CHART start -->
                                                    <div class="col-lg-8">
                                                        <div class="row">
                                                            <div class="card" style=" height: 100%;">
                                                                <div class="card-header">
                                                                    <h5>Km e Consumo Por Data</h5>
                                                                    
                                                                </div>
                                                                <div class="card-block">
                                                                <div id="chart4" style=" height: 90%;"></div>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="card" style=" height: 100%;">
                                                                ...
                                                                <div id="chart_Combo" style=" height: 100%;"></div>
                                                                    </div>                                               

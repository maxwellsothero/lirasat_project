...
$(document).ready(function() {
    ...
    function drawStacked() {
        ...
        fetch('http://67.205.182.209/lirasat_project/Template/default/get_data.php')
            ...
            .then(data => {
                ...
                dataTable.addColumn('string', 'Motorista');
                dataTable.addColumn('number', 'Nota Média Diária');
               
                
               
    
                // Adicione as linhas ao DataTable usando dois loops forEach
                data.forEach(item => {
                    var rowData = [];
                    rowData.push(item['Driver']);
                    rowData.push(item['DailyAverageGrade']);
                ...
                var options = {
                    title: 'Gráfico de Pontuação de Motoristas',
                    chartArea: { width: '80%' },
                    isStacked: true,
                    hAxis: {
